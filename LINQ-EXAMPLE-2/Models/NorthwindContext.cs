...
namespace LINQ_EXAMPLE_2.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<KritikSeviyeUrunBilgileri> KritikSeviyeUrunBilgileris { get; set; } = null!;
        ...
        public virtual DbSet<VWMostExpensiveCondiment> VWMostExpensiveCondiments { get; set; } = null!;
        public virtual DbSet<VwProductSrupplier> VwProductSruppliers { get; set; } = null!;
        public virtual DbSet<VwSalesReport> VwSalesReports { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-IPVME9J\\YUNUS; Database=Northwind; uid=sa; pwd=1234;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KritikSeviyeUrunBilgileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KritikSeviyeUrunBilgileri");
            ...
            modelBuilder.Entity<VWMostExpensiveCondiment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vW_MostExpensive_Condiments");
            ...
            modelBuilder.Entity<VwProductSrupplier>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Vw_product_Srupplier");
            ...
            modelBuilder.Entity<VwSalesReport>(entity =>
            {
                ...
                entity.Property(e => e.KargoFirması).HasMaxLength(40);

                entity.Property(e => e.KargolanmaTarihi).HasColumnType("datetime");

                entity.Property(e => e.MüşteriFirmaAdı).HasMaxLength(40);

                entity.Property(e => e.SatışPersoneliAdı).HasMaxLength(31);

                entity.Property(e => e.SiparişTarihi).HasColumnType("datetime");

                entity.Property(e => e.TeslimAlacakKişi).HasMaxLength(40);
            });
